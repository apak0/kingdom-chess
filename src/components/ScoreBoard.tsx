    ...
    <div className="absolute top-4 left-4 z-50">
      {!isScoreboardOpen ? (
        <motion.button
          ...
          className="bg-[#8B4513] p-3 rounded-lg shadow-lg hover:bg-[#A0522D] transition-colors"
          ...
          >
            <div className="relative bg-[#8B4513] rounded-lg p-4 shadow-2xl border-4 border-[#4A3728]">
              ...
              <div className="relative max-h-96 overflow-y-auto custom-scrollbar">
                {isLoading ? (
                  <div className="text-center py-4 text-[#DEB887]">
                    Loading...
                  </div>
                ) : (
                  <table className="w-full">
                    <thead className="sticky top-0 bg-[#8B4513]">
